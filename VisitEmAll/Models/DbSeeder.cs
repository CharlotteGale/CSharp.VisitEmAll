...
public static class DbSeeder
{
    public static void Seed(VisitEmAllDbContext context)
    {
        ...
        // context.Holidays.RemoveRange(context.Holiday);
        // context.Activities.RemoveRange(context.Activity);
        context.SaveChanges();
        ...
        //     new Holiday { UserId = users[0].Id, Title = "Summer in Santorini", Location = "Greece", StartDate = new DateOnly(2024, 7, 10), EndDate = new DateOnly(2024, 7, 24), Accommodation = "Blue Dome Suites", Cost =  1200.50m },
        //     new Holiday { UserId = user[1].Id, Title = "Skiing in the Alps", Location = "Chamonix, France", StartDate = new DateOnly(2024, 12, 15), EndDate = new DateOnly(2024, 12, 22), Accommodation = "Alpine Lodge", Cost = 850.00m },
        //     new Holiday { UserId = user[3].Id, Title = "Tokyo Adventure", Location = "Japan", StartDate = new DateOnly(2025, 3, 5), EndDate = new DateOnly(2025, 3, 30), Accommodation = "Shinjuki Park Hotel", Cost =  3100.00m },
        //     new Holiday { UserId = user[4].Id, Title = "Weekend in Rome", Location = "Rome, Italy", StartDate = new DateOnly(2024, 5, 12), EndDate = new DateOnly(2024, 5, 15), Accommodation = "AirBnB near Colosseum", Cost = 450.00m },
        //     new Holiday { UserId = user[6].Id, Title = "Hiking in the Highlands", Location = "Scotland", StartDate = new DateOnly(2024, 8, 1), EndDate = new DateOnly(2024, 8, 7), Accommodation = "Campsites", Cost = 560.00 }
        // };
